...
| **Crypto VCP Monitor** | ❌ Not used | ❌ Not used | ❌ Not used | Public spot klines endpoint, no API key; daily OHLCV and latest price; Loads skills/vcp-screener/scripts calculators directly; fails fast if absent |
