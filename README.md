...
| **Crypto VCP Monitor** (`crypto-vcp-monitor`) | Calibrates Minervini VCP thresholds for crypto majors using a keyless-Binance treatment/control backtest; no live detector yet. | `binance_public` **required**, `vcp_screener_calculators` **required** | experimental |
