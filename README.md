...
| **Crypto VCP Monitor** (`crypto-vcp-monitor`) | Calibrates and detects Minervini VCP setups in crypto majors using keyless Binance daily data. | `binance_public` **required**, `vcp_screener_calculators` **required** | experimental |
